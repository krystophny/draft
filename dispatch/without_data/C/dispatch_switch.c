...
Data processValue(Value *value) {
    switch (value->type) {
        case TYPE_INT:
            value->data.doubleValue = processInt(value->data.doubleValue);
            break;
        case TYPE_FLOAT:
            value->data.doubleValue = processFloat(value->data.doubleValue);
            break;
        case TYPE_DOUBLE:
...
int main() {
    ...
    switch (type) {
        case TYPE_INT:
            value.data.doubleValue = 42.0; // Example int value
            break;
        case TYPE_FLOAT:
            value.data.doubleValue = 3.14; // Example float value
            break;
        case TYPE_DOUBLE:
